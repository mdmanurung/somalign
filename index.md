...
transport mass, match fraction, and mass error. Consistent values across
the grid indicate the alignment is not sensitive to the choice of OT
hyperparameters.
...
projects samples in chunks to bound peak memory:
...
for the full pre-trained SOM workflow.
