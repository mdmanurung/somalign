...
Bar chart of the correction vector length per query SOM node, coloured
by whether the correction was applied (green) or suppressed due to low
mass or match fraction (red).
